...
class BrevoClient : IClosableComponent {
     ...
     *
     * Uses the [app.index.api.config.BrevoConfig.emailVerificationTemplateId] for the email template
     */
     ...
     *
     * Uses the [app.index.api.config.BrevoConfig.passwordResetTemplateId] for the email template
     */
     ...
     *
     * Uses the [app.index.api.config.BrevoConfig.passwordResetSuccessTemplateId] for the email template
     */
                ...
                setBody(
                    BrevoListInviteRequestBody(
                        ...
                        BrevoListInviteRequestBody.Params(
                            url = "${BrevoConfig.listUserInviteUrl}?token=$token&email=${URLEncoder.encode(emailTo, "utf-8")}",
