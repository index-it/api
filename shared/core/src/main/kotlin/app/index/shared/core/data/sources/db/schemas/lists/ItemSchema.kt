package app.index.shared.core.data.sources.db.schemas.lists

import app.index.shared.core.data.models.lists.ItemData
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.category
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.completed
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.completed_at
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.created_at
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.edited_at
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.link
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.list
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.name
import app.index.shared.core.data.sources.db.schemas.lists.ItemTable.task
import app.index.shared.core.data.sources.db.schemas.tasks.TaskEntity
import app.index.shared.core.data.sources.db.schemas.tasks.TaskTable
